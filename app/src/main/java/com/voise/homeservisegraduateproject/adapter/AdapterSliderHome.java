...
public class AdapterSliderHome extends RecyclerView.Adapter<AdapterSliderHome.MyViewHolder> {
...
//            main_product = view.findViewById(R.id.card);
    ...
    public AdapterSliderHome(Activity activity, ArrayList<ImageModel_slider> moviesList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View item = null;
        if (viewType == Normal) {
            item = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_slider, parent, false);
        }
// else {
